...
const WorkspaceTabs = ({
    ...
    return (
        <div className="flex flex-col h-full bg-white/10 overflow-hidden">
            {/* Tab Header Bar */}
            <div className="flex-shrink-0 bg-white/40 pb-0 pt-1.5 px-2 border-b border-purple-100 flex items-end justify-between overflow-hidden">
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`text-[11px] font-bold max-w-[140px] truncate transition-all
                                                ...
                                                ${tab.isDeleted ? 'text-red-500 line-through opacity-70' : ''}
                                            `}
                ...
                {tabs.some(t => !t.pinned) && (
                    <div className="flex-shrink-0 flex items-center mb-1.5 ml-2">
                        <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold text-gray-400 hover:text-red-500 hover:bg-red-50 transition-all border border-transparent hover:border-red-100 group shadow-sm bg-white/60 hover:bg-white"
