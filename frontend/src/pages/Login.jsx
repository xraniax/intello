            ...
            <div className="w-full max-w-[400px] card-minimal">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex justify-end">
                        <Link to="/forgot-password" virtual-dom-link="true" className="text-sm font-semibold text-indigo-500 hover:text-indigo-600 transition-colors">
                ...
                <p className="text-center mt-8 text-sm text-gray-500 font-medium">
                    New to Cognify? <Link to="/register" className="text-indigo-500 hover:text-indigo-600 font-bold transition-colors">Create an account</Link>
                </p>
            </div>

            <p className="mt-8 text-xs text-gray-400 font-bold uppercase tracking-widest text-center">
                Refined Clarity &bull; Elegant Focus
            </p>
        </div>
    );
};
